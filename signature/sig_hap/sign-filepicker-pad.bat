...
"%JAVA_HOME%\bin\java" -jar "hapsigntoolv2.jar" sign -mode localjks -privatekey "OpenHarmony Application Release" -inputFile C:\My\Applications\filepicker\product\pad\build\default\outputs\default\pad-default-signed.hap -outputFile FilePicker-pad-signed.hap -keystore "OpenHarmony.p12" -keystorepasswd 123456 -keyaliaspasswd 123456 -signAlg SHA256withECDSA -profile "filepicker.p7b" -certpath "OpenHarmonyApplication.pem"
